...
Select *Preferences > Package Settings > QuickView* from the menu or *Preferences: QuickView Settings* from the command palette to open the package settings and to see the supported converters.
